...
class PostWidget extends StatelessWidget {
  ...
  void _navigateToUserProfile(BuildContext context) {
    ...
    developer.log(
      'Navigating to user profile. Post userId: ${post.userId}, username: ${post.username}',
    );
  ...
  void _navigateToCommenterProfile(BuildContext context, String userId) {
    ...
    final topComment = post.topComments.first;
    developer.log(
      'Navigating to commenter profile. Comment userId: $userId, username: ${topComment.username}',
    );
